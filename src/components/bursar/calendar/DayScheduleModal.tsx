...
export function DayScheduleModal({ date, events, onClose, onEditEvent, onAddEvent, onDeleteEvent }: DayScheduleModalProps) {
    ...
    return (
        <div className="fixed inset-0 bg-black/60 flex items-center justify-center z-50 p-4 animate-fade-in backdrop-blur-sm">
            <div className="bg-white rounded-3xl shadow-2xl w-full max-w-md max-h-[90vh] flex flex-col overflow-hidden relative">
                                    ...
                                    <div className="flex-1 relative pb-2 group">
                                        ...
                                        <div className="bg-white rounded-xl hover:bg-gray-50 transition p-3 -mt-2 -ml-2 pl-4">
                                            ...
                                            <div className="flex gap-3 mt-2 opacity-0 group-hover:opacity-100 transition-opacity duration-200">
                                                <button onClick={() => onEditEvent(evt)} className="text-[10px] font-bold text-gray-400 hover:text-blue-600 uppercase tracking-wide">Edit</button>
                                                <button onClick={() => onDeleteEvent(evt.id)} className="text-[10px] font-bold text-gray-400 hover:text-red-600 uppercase tracking-wide">Delete</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                ...
                <div className="p-4 bg-white border-t border-gray-50 z-20">
                    <button
                        ...
                        className="w-full py-3 bg-gray-900 text-white rounded-2xl font-bold hover:bg-black transition shadow-lg flex items-center justify-center gap-2 transform active:scale-[0.98]"
                    >
